        ...
        <div className="py-12">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8">
            ...
            <div className="lg:col-span-2">
              <h3 className="text-2xl font-bold text-yellow-400 mb-4">Bold Media Group</h3>
              <p className="text-gray-300 mb-6 leading-relaxed">
                Your Voice. Your Brand. Boldly Amplified. Professional podcast production that helps you create amazing content without the technical headaches.
              </p>
        ...
        <div className="border-t border-gray-800 py-8">
          <div className="max-w-md mx-auto text-center">
            ...
            <p className="text-gray-400 mb-6">
              Get the latest podcast production insights and industry trends delivered to your inbox.
            </p>
            <div className="flex flex-col sm:flex-row gap-2">
              <input
                type="email"
                placeholder="Enter your email"
                className="flex-1 px-4 py-3 bg-gray-800 border border-gray-700 rounded-lg text-white placeholder-gray-400 focus:outline-none focus:border-yellow-400 focus:bg-gray-700 transition-all duration-300"
              />
        ...
        <div className="border-t border-gray-800 py-6">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <div className="text-gray-400 text-sm mb-4 md:mb-0">
              © {currentYear} Bold Media Group LLC. All rights reserved.
            </div>
